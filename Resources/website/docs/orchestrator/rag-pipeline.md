...
The builder issues a `SearchRequest` that runs across multiple search lanes simultaneously (see [Unified Search](./unified-search.md)). Results are fused using reciprocal rank fusion (RRF).
